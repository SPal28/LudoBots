...
def Create_Robot():
    ...
    pyrosim.Send_Joint( name = "Link3_Link4" , parent= "Link3" , child = "Link4" , type = "revolute" , position = [x , y + 0.5, z])
    pyrosim.Send_Cube(name="Link4", pos=[x , y + 1, z - 1] , size=[length,width,height])
    pyrosim.End()
Create_Robot()